...
See the screenshots at the top of this page for an idea of what the Excel report looks like, or you can download the file:
...
![Screen shot from 'data_top_bottom' tab of comparison_report.xlsx](https://github.com/skgithub14/compareDFx/raw/master/inst/extdata/all_tab.png)
...
The data tabs (data top-bottom and data left-right) to the far left, you will see some extra columns that report useful comparison information:
...
The next three columns are hidden by default, but can be shown by clicking the "+" in the top left corner of the worksheet:
