...
-  ![](https://placehold.it/150/ffffff/008000?text='Green') ![](https://placehold.it/150/ffffff/008000?text='text'): cell values in `df1` that are different from `df2`

-  <span style="color:red">Red text</span>: cell values in `df2` that are different from `df1`
