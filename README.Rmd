...
-  `exact dup cnt`: if `discrepancy` contains `"exact duplicate"` this column give the number of exact duplicates in `df1` or `df2`
...
![Screen shot from 'all' tab of comparison_report.xlsx](inst/extdata/comparison_report_screenshot.png)

See the full MS Excel file here (only clickable on when viewing on [https://skgithub14.github.io/compareDFx/](https://skgithub14.github.io/compareDFx/)):

```{r, echo=FALSE}
xfun::embed_file(file.path(dir, "comparison_report.xlsx"))
```
